...
public class CustomSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener,
    ...
    public CustomSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        switch (layoutPos) {
            case 0: 
                setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_custom_seekbar_mid2);
                break;
            case 1:
                setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_custom_seekbar_top);
                break;
            case 2:
                setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_custom_seekbar_mid);
                break;
            case 3:
                setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_custom_seekbar_bot);
                break;
            default:
